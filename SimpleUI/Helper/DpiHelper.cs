...
public static class DpiHelper
{
    ...
    static DpiHelper()
    {
        ...
        if (dC != IntPtr.Zero)
        {
            ...
            DeviceDpiX = User.GetDeviceCaps(dC, logicPixelsX);
            DeviceDpiY = User.GetDeviceCaps(dC, logicPixelsY);
            User.ReleaseDC(IntPtr.Zero, dC);
        }
        else
        {
